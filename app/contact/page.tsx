    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="border border-gray-300 p-8 md:p-16 text-center bg-white shadow-sm">
        ...
        <p className="text-gray-700 mb-16 max-w-2xl mx-auto leading-relaxed">
          หากพบปัญหาการใช้งานเว็บไซต์หรือมีข้อสงสัยในการใช้งานเว็บไซต์ สามารถติดต่อทีมงานได้ ผ่านช่องทางดังต่อไปนี้ Line Official Account หรือทาง Facebook เรา พร้อมให้บริการคุณอย่างทันท่วงที ทำงานว่องไวทันใจไม่ให้คุณต้องรอนาน กรุณาเลือกช่องทางติดต่อโดยกดที่ลิงก์ด้านล่างได้เลย
        </p>
